...
?>
    ...
    <div class="container demo-2">
        <div id="slider" style="min-height: 500px" class="sl-slider-wrapper">
            ...
            <div id="mc_embed_signup" class="mailchimp">
                <div class="cont inp_btn">
                    <form autocomplete="off" action="//moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=?" method="get" id="mc-embedded-subscribe-form-home" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
//                'offset'           => $offset,
            ...
            if(!empty($posts)) {
                ...
                <div class="searchR">
                    <p>
                        <span class="mini">Search results for</span>
                        <span class="big"><?php echo $_GET['s']; ?></span>
                    </p>
                ...
                <div class="searchR">
                    <p>
                        <span>We couln’t find anyhing for your search:</span>
                        ...
                        <div <?php if($type == 'text') echo 'style="width:100%"' ?> class="post_right">
                            ...
                            <div class="post_date">
                                ...
                                if($tagE != '')
                                    ...
                                    $tagE = '';
                                echo get_the_date() .  $tagE . '/ <span class="livefyre-commentcount" data-lf-site-id="380413" data-lf-article-id="' . $id . '">0</span> Comments';?>
                            </div>
