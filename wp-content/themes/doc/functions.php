...
function nums($type, $perPage){
    ...
    if(intval($count_posts->publish) >= $perPage)
//        var_dump(intval($count_posts->publish));
    {
...
function get_years(){
    ...
    if($yearliest_year){
        ...
        while($current_year > $this_year - 1){
...
//    }
    ...
    $result = fetchData("https://api.instagram.com/v1/users/192962714/media/recent/?access_token=2664767773.ab103e5.67d62724b60147dfab767b818381d853&count=8");
...
if( !is_admin()){
    ...
    wp_register_script('jquery', ("https://cdnjs.cloudflare.com/ajax/libs/jquery-tools/1.2.7/jquery.tools.min.js"), false, '1.2.7');
