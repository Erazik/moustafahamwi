    ...
    <div class="aboutme">
        ...
        <div class="aboutme_content_title">
            ...
            <?php
            global $cfs, $tag, $post;
            if($cfs->get('about_title_in_home_page', 10 )){
                $text = $cfs->get('about_title_in_home_page', 10 );
                echo($text);
            }
            ?>
    ...
    <div class="archive">
        ...
        if(!is_single()) {
            ...
            <div class="subscribe">
                ...
                <div class="subscribe_content">
                    <div class="inp_btn">
                        <form autocomplete="off" action="//moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=?" method="get" id="mc-embedded-subscribe-form-sidebar" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        ...
        <div class="subscribe">
            ...
            foreach($posts as $item) {
                ...
                $out .= '<a class="miniDate_text" href= "' . get_the_permalink($id) . '">'.substr(get_the_title($id), 0, 71).'</a>';
                $out .= '</div>';
