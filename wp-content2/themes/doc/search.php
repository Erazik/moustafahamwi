        ...
        <div id="slider" style="min-height: 667px" class="sl-slider-wrapper">
            ...
            <div id="mc_embed_signup" class="mailchimp">
                <div class="cont inp_btn">
                    <form autocomplete="off" action="http://moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=?" method="get" id="mc-embedded-subscribe-form-search" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<!--            </div>-->
    ...
    <div class="ask">
        <div class="cont">
            ...
            <div class="ask_btn">
                <a href="http://moustafahamwi.com/connect/">Ask Now!</a>
            </div>
        </div>
    </div>
