...
<div class="cont content">
	<div class="content_left">
		<h1 class="archive-title"><?php
			if ( is_day() ) :
				printf( __( 'Daily Archives: %s', 'doc' ), get_the_date() );
			elseif ( is_month() ) :
				printf( __( 'Monthly Archives: %s', 'doc' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'doc' ) ) );
			elseif ( is_year() ) :
				printf( __( 'Yearly Archives: %s', 'doc' ), get_the_date( _x( 'Y', 'yearly archives date format', 'doc' ) ) );
			else :
				_e( 'Archives', 'doc' );
			endif;
			?></h1>
