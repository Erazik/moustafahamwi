    ...
    <div id="slider" style="min-height: 667px" class="sl-slider-wrapper">
        ...
        <div id="mc_embed_signup" class="mailchimp">
            <div class="cont inp_btn">
                ...
                <form autocomplete="off" method="post"  id="mc-embedded-subscribe-form-category" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll">
                        <div class="mailchimp_text">
                            <p>
                                Want more PASSION in your life? Subscribe the weekly Passion dose for FREE.
                            </p>
                        </div>
                        <div class="mc-field-group">
                            <div class="element">
            ...
            foreach($posts as $item) {
                ...
                <div class="post">
                    <a href="<?php echo get_the_permalink($id); ?>">
                        ...
                        if($type != 'text') echo ' <div class="post_img'.$class.'">' . $type . '</div>'; ?>
                        <div <?php
                        if($type == 'text')
                        {
