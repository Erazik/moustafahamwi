...
<!--        <div class="share_img" style="display: none">--><?php //the_post_thumbnail( $id, 'thumbnail' ); ?><!--</div>-->
        <div id="mc_embed_signup" class="mailchimp">
            <div class=" inp_btn">
                <form action="//moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=?" method="get" id="mc-embedded-subscribe-form-single" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll">
                        ...
                        <div class="mc-field-group">
                            <div class="element">
                                <input type="text"  name="FNAME" class=" inp1" id="mce-FNAME" placeholder="Full Name" />
                                <p class="element_error"></p>
                            </div>
                            <div class="element">
                                <input type="email" name="EMAIL" class="required email  inp1" id="mce-EMAIL" placeholder="Your email address"  />
                                <p class="element_error"></p>
                            </div>
                            <input type="submit" value="I want PASSION" name="subscribe" id="mc-embedded-subscribe" class="button  btn1">
                        </div>
        ...
        <div class="single_right_top">
            <div id="mc_embed_signup" class="mailchimp_single">
                <div class="inp_btn_single">
                    <form autocomplete="off" action="//moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=??" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div id="mc_embed_signup_scroll">
