...
<div class="about_content">
    ...
    <!--                <div class="ellipse_name"><p>Moustafa Hamwi</p></div>-->
                    <div class="ellipse_content">
                        <div class="ellipse_content1"><p>SPEAKER, COACH, ADVENTURER AND a Passionpreneur. </p></div>
...
<!--            <form action="http://moustafahamwi.us12.list-manage.com/subscribe/post-json?u=4db02be49a9a2c776ff45b166&amp;id=77cc7efe5a&amp;c=?" method="get" id="mc-embedded-subscribe-form-about" name="mc-embedded-subscribe-form"autocomplete="off" class="validate" target="_blank" novalidate>-->
...
<!--    </div>-->
    <div id="mc_embed_signup" class="mailchimp">
        <div class="cont inp_btn">
            <form autocomplete="off"  method="post" id="mc-embedded-subscribe-form-about" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                <div id="mc_embed_signup_scroll">
    ...
    <div class="middle1">
        <div class="cont about_middle">
            ...
            <div class="about_middle_right"><img src="<?php bloginfo('template_url')?>/images/about-sun.png"></div>
        </div>
        <div class=" cont about_middle_btn"><a href="http://moustafahamwi.com/connect/">Connect</a></div>
    </div>
    ...
    <div  class="mission">
        <div class="cont miss" >
            ...
            <div class="mission_hero"><img src="<?php bloginfo('template_url')?>/images/mission-hero.png" ></div>
        </div>
    ...
    <div id="mc_embed_signup" class="mailchimp">
        <div class="cont inp_btn">
            <form autocomplete="off" method="post" id="mc-embedded-subscribe-form-home" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                <div id="mc_embed_signup_scroll">
                    <div class="mailchimp_text">
                        <p>
